...
d.className+" ie-old":"ie-old");return b};c.showScreen=function(a,b){a=a||c.options.language;b=Number(b)||c.options.availability;var d=h(),e=document.getElementsByTagName("body")[0];d&&d<=b&&(e.innerHTML+=c.template.replace("{title}",c.languages[a].title).replace("{description}",c.languages[a].description))};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=c),exports.iecap=c):"function"===typeof define&&define.amd?define([],function(){return c}):f.iecap=
c})(this);